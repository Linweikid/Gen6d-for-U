...
(cl:defmethod Plan_version-val ((m <Arm_Software_Version>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_msgs-msg:Plan_version-val is deprecated.  Use rm_msgs-msg:Plan_version instead.")
  (Plan_version m))
