...
class Tool_IO_State {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.int8(obj.Tool_IO_Mode, buffer, bufferOffset, 2);
    ...
    bufferOffset = _arraySerializer.int8(obj.Tool_IO_State, buffer, bufferOffset, 2);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.Tool_IO_Mode = _arrayDeserializer.int8(buffer, bufferOffset, 2)
    // Deserialize message field [Tool_IO_State]
    data.Tool_IO_State = _arrayDeserializer.int8(buffer, bufferOffset, 2)
    return data;
  }
  ...
  static md5sum() {
    ...
    return '3a8d67c6456299e65ebafb60fec4550b';
  }

  static messageDefinition() {
    // Returns full string definition for message
    return `
    int8[2] Tool_IO_Mode          #数字I/O输入/输出状态  0-输入模式，1-输出模式
