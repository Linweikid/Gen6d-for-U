...
"""autogenerated by genpy from rm_msgs/Joint_PoseEuler.msg. Do not edit."""
import codecs
import sys
...
class Joint_PoseEuler(genpy.Message):
  _md5sum = "9254815d452fb49553cab1a1384a3e0a"
  _type = "rm_msgs/Joint_PoseEuler"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float32[3] euler
float32[3] position
"""
  __slots__ = ['euler','position']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Joint_PoseEuler, self).__init__(*args, **kwds)
