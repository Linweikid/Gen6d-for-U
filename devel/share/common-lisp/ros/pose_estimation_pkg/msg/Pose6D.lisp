...
(cl:in-package pose_estimation_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Pose6D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose6D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pose_estimation_pkg-msg:<Pose6D> is deprecated: use pose_estimation_pkg-msg:Pose6D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Pose6D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimation_pkg-msg:x-val is deprecated.  Use pose_estimation_pkg-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pose6D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimation_pkg-msg:y-val is deprecated.  Use pose_estimation_pkg-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Pose6D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimation_pkg-msg:z-val is deprecated.  Use pose_estimation_pkg-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'rx-val :lambda-list '(m))
(cl:defmethod rx-val ((m <Pose6D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimation_pkg-msg:rx-val is deprecated.  Use pose_estimation_pkg-msg:rx instead.")
  (rx m))

(cl:ensure-generic-function 'ry-val :lambda-list '(m))
(cl:defmethod ry-val ((m <Pose6D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimation_pkg-msg:ry-val is deprecated.  Use pose_estimation_pkg-msg:ry instead.")
  (ry m))

(cl:ensure-generic-function 'rz-val :lambda-list '(m))
(cl:defmethod rz-val ((m <Pose6D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_estimation_pkg-msg:rz-val is deprecated.  Use pose_estimation_pkg-msg:rz instead.")
  (rz m))
